...
//[.thumb]
image::reloadly-db-schemas.png[scaledwidth=65%]
...
[TIP]
====
Consider writing a small shell script, or add these in your `~/.zprofile` of `~./bashprofile` file or a suitable method of your liking.
====
