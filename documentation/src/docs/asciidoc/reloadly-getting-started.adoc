...
After running these scripts, you must have the schemas correctly created. Please verify. The following image shows the tables in IntelliJ Idea Data Explorer (you can use any tool of your choice).
