...
public class HelloControllerTests extends AbstractIntegrationTest{
    ...
    @Test
    public void should_get_get_hello_message_without_mock_security_header() throws Exception {
        String testUid = "c1fe6f0d-420e-4161-a134-9c2342e36c95";
        // Act and Assert
...
//    @Test
    ...
    private String getBearerTestToken(boolean validToken) {
        ...
        String goodIdToken = "eyJhbGciOiJIUzM4NCJ9..G8VH2JSeeEK7i-HE00P68EU2gkVsMJq7KsbIXECLZEsj3iIrM7veC8AymXz0LlwI";
